...
namespace WebApplication3
{
    public partial class AnimationForm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //Indepandent Diagram
            ExplainTheDiagramLbl1.Text = "<strong> In this case we see that this patient has: " +
                     " crohn's in the family (the answer is Yes) " +
                    "  and <u> high </u> Headache level.<br/>" +
                    " Therefore, the diagnosis is <u> SUSPECTED CROHN'S </u>. (as you can see in the last circle of the green path) </strong>";
