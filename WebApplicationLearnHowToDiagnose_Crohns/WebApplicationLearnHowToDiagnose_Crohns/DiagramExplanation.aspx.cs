    ...
    public partial class DiagramExplanation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ExplainTheDiagramLbl.Text = "<br/>&nbsp The following diagram is an example that will help us to learn to determine how likely a specific patient has Crohn's based on his data." + "<br/>";
