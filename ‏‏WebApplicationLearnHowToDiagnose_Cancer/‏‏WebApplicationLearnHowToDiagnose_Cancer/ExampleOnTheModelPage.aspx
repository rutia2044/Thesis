                     ...
                     <td  style="width: 35%;height:100%;">
                         <div class="auto-style1"><strong>&nbsp PATIENT DATA:<br /></strong>
                             <asp:Panel ID="panel1" runat="server"  Height="90%" Width="100%" BackColor="#F0F0F0">
                                 <asp:Label ID="Label_1_a"  runat="server" BackColor="LightGreen">&nbsp IS THERE CANCER IN THE FAMILY?: </asp:Label>&nbsp<asp:Label ID="lblYearsSinceAcidTasteStart" BackColor="LightGreen"  runat="server"></asp:Label><br/><br/>
                                 ...
                                 <asp:Label ID="Label_3_b" runat="server">&nbsp TAKING STOMACH MEDICINES: </asp:Label>&nbsp<asp:Label ID="lblTakingStomachMed" runat="server"></asp:Label><br/><br/>
                                  <asp:Label ID="Label_3_d" runat="server">&nbsp BURNING CHEST LEVEL: </asp:Label>&nbsp<asp:Label ID="lblBurningChest" runat="server"></asp:Label><br/><br/>
